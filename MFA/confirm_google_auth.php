...
if (isset($_POST['btnValidate'])) {
    ...
    else
    {
        if($pga->verifyCode($user->googleSecret, $code, 2))
        {
            // success
            $_SESSION["RegState"] = 1;
            $_SESSON["Message"] = "Account validated. Please complete email authentication.";
        ...
        else
        {
            ...
            $_SESSION["Message"] = 'Invalid Authentication Code!';
        }
    }
}
?>
...
<body>
  <div class="register">
      ...
      <div class="form-group">Go Back to <a href="../index.html"> Login </a></div>
  </div>
</body>
</html>
